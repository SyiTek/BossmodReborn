...
sealed class M12SLindwurmStates : StateMachineBuilder
{
    ...
    private void GrotesquerieAct1(uint id, float delay)
    {
        ...
        // Stack/spread
        ComponentCondition<SharedGrotesquerieAct1>(id + 0x21, 0.3f, g => g.NumCasts > 0, "Stack/spread/cones")
        ...
        // Tankbuster spreads
        ComponentCondition<VisceralBurst>(id + 0x31, 0.5f, v => v.NumCasts > 0, "Stack + tankbusters")
    ...
    private void GrotesquerieCurtainCall(uint id, float delay)
    {
        ...
        ComponentCondition<GrotesquerieCurtainCall>(id + 0x30, 0.4f, c => c.NumCasts > 0, "Spreads")
            .ActivateOnEnter<Burst>();
